...
void cChunk::MoveEntityToNewChunk(StoredEntity a_Entity)
{
...
void cChunk::AddEntity(StoredEntity a_Entity)
{
...
StoredEntity cChunk::RemoveEntity(cEntity & a_Entity)
{
